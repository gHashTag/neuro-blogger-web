...
if (!process.env.NEXT_PUBLIC_TELEGRAM_BOT_TOKEN_VIBECODER999) {
  throw new Error("NEXT_PUBLIC_TELEGRAM_BOT_TOKEN_VIBECODER999 is not set");
}
...
const tokenProd = process.env.NEXT_PUBLIC_TELEGRAM_BOT_TOKEN_VIBECODER999;
