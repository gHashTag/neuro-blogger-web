...
const items = [
  {
    title: 'Создание Нейрофото',
    description: (
      <span className='text-sm'>
        Откройте для себя возможности ИИ в создании уникальных изображений.
      </span>
    ),
    header: <SkeletonOne />,
  ...
  },
  {
    ...
    description: (
      <span className='text-sm'>Доверьте ИИ обработку ваших изображений.</span>
    ),
    header: <SkeletonTwo />,
    className: 'md:col-span-1',
  ...
  },
  {
    ...
    description: (
      <span className='text-sm'>
        Получайте рекомендации по улучшению ваших фото с помощью ИИ.
      </span>
    ),
  ...
  },
  {
    ...
    description: (
      <span className='text-sm'>
        Понимайте настроение ваших изображений с помощью ИИ-анализа.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  },
  {
    ...
    description: (
      <span className='text-sm'>
        Сжимайте ваши изображения без потери качества с помощью ИИ.
      </span>
    ),
    header: <SkeletonFive />,
    className: 'md:col-span-1',
