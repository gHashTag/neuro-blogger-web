        ...
        >
          <AnimatePresence mode='wait'>
            {hoveredIndex === item.id && (
              ...
              >
                <div className='absolute inset-x-10 -bottom-px z-30 h-px w-[20%] bg-gradient-to-r from-transparent via-yellow-500 to-transparent' />
                <div className='absolute -bottom-px left-10 z-30 h-px w-[40%] bg-gradient-to-r from-transparent via-yellow-300 to-transparent' />
                <div className='relative z-30 text-base font-bold text-yellow-500'>
                  {item.name}
                </div>
